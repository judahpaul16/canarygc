<script lang="ts">
  ...
  function handleLiveFeedFullScreen() {
...
<div class="live-feed bg-[#1c1c1e] text-white rounded-lg h-full relative">
  <div class="relative h-full bg-gray-700 rounded-lg">
    ...
    <button class="absolute top-2 right-2 text-white bg-gray-800 bg-opacity-75 p-2 px-3 hover:bg-blue-400 rounded-full" on:click={handleLiveFeedFullScreen}>
