...
>
  <div class="container w-full h-full relative">
    ...
    <iframe allowfullscreen id="live-feed" title="Live Feed" src={ typeof window !== 'undefined' ? `http://${window.location.hostname}:8889/cam1`  : ''} class="bg-black absolute top-0 w-full h-full object-cover rounded-lg z-0"></iframe>
