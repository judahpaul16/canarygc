<script lang="ts">
  ...
  let action_types = [
    ...
    'NAV_LOITER_TIME', 'NAV_LOITER_TURNS', 'NAV_LOITER_UNLIM', 'DO_WINCH', 'DO_SET_CAM_TRIGG_DIST',
  ...
  let action_markers = [
    ...
    'map/loiter.png', 'map/loiter.png', 'map/loiter.png', 'map/do_winch.png', 'map/camera.png',
